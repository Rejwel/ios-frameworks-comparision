...
final class inz_swiftuiUITests: XCTestCase {
    ...
    func testPhotoViewPerformance() throws {
        ...
        let scrollView = app.scrollViews["scroll-view"]
        
        let cell = app.buttons["photo-button-66E8FCD5-0376-41DA-AE3D-031327D7C81B"]
        cell.tap()
        ...
        let cell2 = app.buttons["photo-button-2695C694-6016-4994-BB7C-689868E67F3F"]
        cell2.tap()
